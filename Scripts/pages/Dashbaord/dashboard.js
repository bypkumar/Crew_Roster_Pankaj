...
function dateRangeChange() {
    ...
    if (DashboardType != 1 && DashboardType != 2 && DashboardType != 0 && DashboardType != 3) {
        console.log("PROBLEM IS HERE 12");
        GetBaseDD();
        loadRankWithMultipleDD();
        GetStaffIdAndEmployeeName();
    }
...
function GetBaseDD() {
    ...
    $.ajax({
        type: 'POST',
        url: applicationUrl + "CrewRosterReport/GetBaseList",
        dataType: 'json',
        data: {
            fromDate: function () { return $("#TxtFromDate").val(); },
            toDate: function () { return $("#TxtToDate").val(); },
...
function loadRankWithSignleDD() {
    ...
    $.ajax({
        type: 'POST',
        url: applicationUrl + "CrewRosterReport/Get_RankListForDD",
        dataType: 'json',
        data: {
            fromDate: function () { return $("#TxtFromDate").val(); },
            toDate: function () { return $("#TxtToDate").val(); },
...
function GetStaffIdAndEmployeeName() {
    ...
    $.ajax({
        type: 'POST',
        url: applicationUrl + "CrewRosterReport/Get_StaffListForDD",
        dataType: 'json',
        data: {
            fromDate: function () { return $("#TxtFromDate").val(); },
            toDate: function () { return $("#TxtToDate").val(); },
        ...
        success: function (data) {
            ...
            for (var j = 0; j < type.length; j++) {
                $('#EmployeeName').append('<option value="' + type[j].Id + '">' + type[j].EmployeeName + '</option>');
            }
    ...
    $.ajax({
        type: 'POST',
        url: applicationUrl + "CrewRosterReport/Get_EmployeeNameForDD",
        dataType: 'json',
        data: {
            fromDate: function () { return $("#TxtFromDate").val(); },
            toDate: function () { return $("#TxtToDate").val(); },
...
function GetRosterDD() {
    ...
    $.ajax({
        type: 'POST',
        url: applicationUrl + "CrewRosterReport/Get_RosterListForDD",
        dataType: 'json',
        data: {
            fromDate: function () { return $("#TxtFromDate").val(); },
            toDate: function () { return $("#TxtToDate").val(); },
...
function GetMonthDD() {
    ...
    $.ajax({
        type: 'POST',
        url: applicationUrl + "CrewRosterReport/Get_MonthListForDD",
        dataType: 'json',
        data: {
            fromDate: function () { return $("#TxtFromDate").val(); },
            toDate: function () { return $("#TxtToDate").val(); },
...
function loadMonthChart_one(month_name) {
    ...
    $.ajax({
        type: 'POST',
        url: applicationUrl + "CrewRosterReport/Get_DashboardMonthWisePercentage",
        dataType: 'json',
        data: {
            fromDate: function () { return $("#TxtFromDate").val(); },
            toDate: function () { return $("#TxtToDate").val(); },
                ...
                chart: {
                    ...
                    events: {
                        drilldown: function (e) {
                            ...
                            $.ajax({
                                type: 'POST',
                                url: applicationUrl + "CrewRosterReport/DashboardSelectedRosterWisePercentage",
                                dataType: 'json',
                                data: {
                                    fromDate: function () { return $("#TxtFromDate").val(); },
                                    toDate: function () { return $("#TxtToDate").val(); },
...
function loadRosterChart_one(roster_name) {
    ...
    $.ajax({
        type: 'POST',
        url: applicationUrl + "CrewRosterReport/Get_DashboardRosterWisePercentage",
        dataType: 'json',
        data: {
            fromDate: function () { return $("#TxtFromDate").val(); },
            toDate: function () { return $("#TxtToDate").val(); },
...
function loadOnloadChart_dateWise() {
    ...
    $.ajax({
        type: 'POST',
        url: applicationUrl + "CrewRosterReport/Dashboard_all_StaffWisePercentage",
        dataType: 'json',
        data: {
            fromDate: function () { return $("#TxtFromDate").val(); },
            toDate: function () { return $("#TxtToDate").val(); },
                    ...
                    events: {
                        drilldown: function (e) {
                            ...
                            if (drilldown_count == 1) {
                                ...
                                $.ajax({
                                    type: 'POST',
                                    url: applicationUrl + "CrewRosterReport/Dashboard_one_StaffWisePercentage",
                                    dataType: 'json',
                                    data: {
                                        fromDate: function () { return $("#TxtFromDate").val(); },
                                        toDate: function () { return $("#TxtToDate").val(); },
...
function loadOnloadChart_MultStaffIdWise() {
    ...
    $.ajax({
        type: 'POST',
        url: applicationUrl + "CrewRosterReport/Get_DashboardStaffWisePercentage",
        dataType: 'json',
        data: {
            fromDate: function () { return $("#TxtFromDate").val(); },
            toDate: function () { return $("#TxtToDate").val(); },
...
function loadOnloadChart_secOne() {
    ...
    $.ajax({
        type: 'POST',
        url: applicationUrl + "CrewRosterReport/Get_DashboardOnloadrWisePercentage",
        dataType: 'json',
        data: {
                    ...
                    events: {
                        drilldown: function (e) {
                            ...
                            if (drilldown_count == 2) {
                                ...
                                $.ajax({
                                    type: 'POST',
                                    url: applicationUrl + "CrewRosterReport/DashboardOnload_one_StaffWisePercentage",
                                    dataType: 'json',
                                    data: {
                                        fromDate: function () { return fromDate },
                                        toDate: function () { return toDate },
                                ...
                                $.ajax({
                                    type: 'POST',
                                    url: applicationUrl + "CrewRosterReport/Get_DashboardonloadBaseandRankwisepercentage",
                                    dataType: 'json',
                                    data: {
                                        fromDate: function () { return fromDate },
                                        toDate: function () { return toDate },
                ...
                chart: {
                    ...
                    events: {
                        drilldown: function (e) {
                            ...
                            $.ajax({
                                type: 'POST',
                                url: applicationUrl + "CrewRosterReport/DashboardSelectedMonthWisePercentage",
                                dataType: 'json',
                                data: {
                                    fromDate: function () { return $("#TxtFromDate").val(); },
                                    toDate: function () { return $("#TxtToDate").val(); },
...
function getChartDatafor_secOne(base_name) {
    ...
    $.ajax({
        type: 'POST',
        url: applicationUrl + "CrewRosterReport/Get_DashboardBaseWisePercentage",
        dataType: 'json',
        data: {
            fromDate: function () { return $("#TxtFromDate").val(); },
            toDate: function () { return $("#TxtToDate").val(); },
                    ...
                    events: {
                        drilldown: function (e) {
                            ...
                            if (drilldown_count == 1) {
                                ...
                                $.ajax({
                                    type: 'POST',
                                    url: applicationUrl + "CrewRosterReport/DashboardRankWisePercentage",
                                    dataType: 'json',
                                    data: {
                                        fromDate: function () { return $("#TxtFromDate").val(); },
                                        toDate: function () { return $("#TxtToDate").val(); },
...
function getChartDataStaffIDfor_secOne_forOne() {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            var per_total_new = 0;
            console.log(per_total_new + " per_total_new_before");

            //data1 = data
            $.each(data, function (i, item) {
                data1.push({ 'name': item.DutyDate, 'y': parseFloat(item.Percentage), 'drilldown': item.DutyDate })
                per_total_new = per_total_new + parseFloat(item.Percentage)
            });

            per_total_new = per_total_new.toFixed(2)
            var per_total = 0;
            ...
            console.log("chart data1..", data1)
            console.log("per_total_new_after" + per_total_new)
            ...
            Highcharts.chart('container_one', {
                ...
                title: {
                    //       text: 'Changee ' + per_total + ' %'
                    text: 'Change ' + per_total_new + ' %'
                },
                xAxis: {
                    type: 'category',
                    labels: {
...
function getChartDataStaffIDfor_secTwo_forOne() {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            var per_total_new_nochange = 0;
            console.log(per_total_new_nochange + " per_total_new_nochange");

            //data1 = data
            $.each(data, function (i, item) {
                data1.push({ 'name': item.DutyDate, 'y': parseFloat(item.Percentage), 'drilldown': item.DutyDate })
                per_total_new_nochange = per_total_new_nochange + parseFloat(item.Percentage)
            });

            per_total_new_nochange = per_total_new_nochange.toFixed(2)
            var per_total = 0;
            var data_lenght = data1.length;
            ...
            Highcharts.chart('container_two', {
                ...
                title: {
                    text: 'No Change ' + per_total_new_nochange + ' %'
                },
                xAxis: {
                    type: 'category',
                    labels: {
...
function getChar_single_rank_secOne(rank_name) {
    ...
    $.ajax({
        type: 'POST',
        url: applicationUrl + "CrewRosterReport/Get_DashboardCrewRankWisePercentage",
        dataType: 'json',
        data: {
            fromDate: function () { return $("#TxtFromDate").val(); },
            toDate: function () { return $("#TxtToDate").val(); },
...
function getChart_rank_secOne(rank_name) {
    ...
    $.ajax({
        type: 'POST',
        url: applicationUrl + "CrewRosterReport/Get_DashboardSelectedCrewRankWisePercentage",
        dataType: 'json',
        data: {
            fromDate: function () { return $("#TxtFromDate").val(); },
            toDate: function () { return $("#TxtToDate").val(); },
...
function LoadBaseWiseGrid() {
    ...
    $("#baseWiseGrid").jqGrid({
        url: applicationUrl + "CrewRosterReport/Get_Grid_DashboardBaseWiseDataForGrid",
        datatype: "json",
        mtype: 'POST',
        postData: {
            FromDate: function () { return $("#TxtFromDate").val(); },
...
function LoadStaffWiseGrid() {
    ...
    $("#staffwiseGrid").jqGrid({
        url: applicationUrl + "CrewRosterReport/Get_Grid_sp_DashboardStaffWiseDataForGrid",
        datatype: "json",
        mtype: 'POST',
        postData: {
            FromDate: function () { return $("#TxtFromDate").val(); },
...
function LoadStaffWiseGrid_typeTwo() {
   // if ($("#baseCode").val() = null) {
    alert($("#baseCode").val().length)
    console.log("$val()" + $("#baseCode").val())
    //}
   // else {
    //    alert("not null")
   // }
    ...
    $("#staffnDatewiseGrid").jqGrid({
        url: applicationUrl + "CrewRosterReport/Get_Grid_sp_DashboardStaffnDateWiseDataForGrid",
        datatype: "json",
        mtype: 'POST',
        postData: {
            FromDate: function () { return $("#TxtFromDate").val(); },
...
function LoadRankWiseGrid() {
    ...
    $("#rankwiseGrid").jqGrid({
        url: applicationUrl + "CrewRosterReport/Get_Grid_sp_DashboardCrewRankWiseDataForGrid",
        datatype: "json",
        mtype: 'POST',
        postData: {
            FromDate: function () { return $("#TxtFromDate").val(); },
...
function LoadOnloadWiseGrid() {
    ...
    $("#OnloadGrid").jqGrid({
        url: applicationUrl + "CrewRosterReport/Get_Grid_sp_DashboardOnLoadDataForGrid",
        datatype: "json",
        mtype: 'POST',
        postData: {
            fromDate: function () { return fromDate },
            toDate: function () { return toDate },
           // fromDate: function () { return '01-12-2021' },
           // toDate: function () { return '31-12-2021' },
            crewRank: function () {
                if (RankDDType == 1) {
                    return $("#TxtRankSingleSelect").val();
                } else {
