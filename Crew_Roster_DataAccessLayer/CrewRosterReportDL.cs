...
namespace Crew_Roster_DataAccessLayer
{
    public class CrewRosterReportDL
    {
        SqlHelper sqlHelper;
        ...
        public List<CrewRosterReport> Get_crewRosterReport(SearchCriteria search)
        {
            ...
            try
            {
                SqlCommand cmd = sqlHelper.GetStoreProcedureCommand("[dbo].[sp_CabinPlanActualDutyNew]");
        ...
        public List<CrewType> Get_CrewRank(SearchCriteria search)
        {
            ...
            try
            {
                SqlCommand cmd = sqlHelper.GetStoreProcedureCommand("[dbo].[sp_DropdwonForCrewRank]");
                ...
                if (Dr.HasRows)
                {
                    while (Dr.Read())
                    {
                        ...
                        obj_CrewType.RepositoryID = Convert.ToString(Dr["RepositoryID"]);
                        obj_CrewType.RepositoryName = Convert.ToString(Dr["RepositoryName"]);
                        obj_CrewType.RepositoryShortName = Convert.ToString(Dr["RepositoryShortName"]);
        ...
        public List<Employee> Get_employee(SearchCriteria search)
        {
            ...
            try
            {
                SqlCommand cmd = sqlHelper.GetStoreProcedureCommand("[dbo].[sp_DropdwonForEmployeeName]");
        ...
        public List<Base> Get_Base(SearchCriteria search)
        {
            ...
            try
            {
                SqlCommand cmd = sqlHelper.GetStoreProcedureCommand("[dbo].[sp_DropdwonForBase]");
        ...
        public List<Employee> Get_StaffList(SearchCriteria search)
        {
            ...
            try
            {
                SqlCommand cmd = sqlHelper.GetStoreProcedureCommand("[dbo].[sp_DropdwonForStaffId]");
        ...
        public List<Employee> Get_StaffListForDD(SearchCriteria search)
        {
            ...
            try
            {
                SqlCommand cmd = sqlHelper.GetStoreProcedureCommand("[dbo].[sp_DashboardDropdwonForStaffId]");
        ...
        public List<Employee> Get_EmployeeNameForDD(SearchCriteria search)
        {
            ...
            try
            {
                SqlCommand cmd = sqlHelper.GetStoreProcedureCommand("[dbo].[sp_DashboardDropdwonForEmployeeName]");
        ...
        public List<Employee> Get_RankListForDD(SearchCriteria search)
        {
            ...
            try
            {
                SqlCommand cmd = sqlHelper.GetStoreProcedureCommand("[sp_DashboardDropdwonForCrewRank]");
        ...
        public List<Base> Get_BaseListForDD(SearchCriteria search)
        {
            ...
            try
            {
                SqlCommand cmd = sqlHelper.GetStoreProcedureCommand("[dbo].[sp_DashboardDropdwonForBase]");
        ...
        public List<Employee> Get_RosterListForDD(SearchCriteria search)
        {
            ...
            try
            {
                SqlCommand cmd = sqlHelper.GetStoreProcedureCommand("[dbo].[sp_DashboardDropdwonForRoster]");
        ...
        public List<Employee> Get_MonthListForDD(SearchCriteria search)
        {
            ...
            try
            {
                SqlCommand cmd = sqlHelper.GetStoreProcedureCommand("[dbo].[sp_DashboardDropdwonForMonth]");
        ...
        public List<Dashboardchart> Get_DashboardBaseWisePercentage(SearchCriteria search)
        {
            ...
            try
            {
                SqlCommand cmd = sqlHelper.GetStoreProcedureCommand("[dbo].[sp_DashboardBaseWisePercentage]");
        ...
        public List<Dashboardchart> DashboardRankWisePercentage(SearchCriteria search)
        {
            ...
            try
            {
                SqlCommand cmd = sqlHelper.GetStoreProcedureCommand("[dbo].[sp_DashboardRankWisePercentage]");
        ...
        public List<Dashboardchart> DashboardonloadBaseandRankwisepercentage(SearchCriteria search)
        {
            ...
            try
            {
                SqlCommand cmd = sqlHelper.GetStoreProcedureCommand("[dbo].[sp_DashboardonloadBaseandRankwisepercentage]");
        ...
        public List<Dashboardchart> DashboardBase_RankCrewwisepercentage(SearchCriteria search)
        {
            ...
            try
            {
                SqlCommand cmd = sqlHelper.GetStoreProcedureCommand("[dbo].[sp_DashboardBase_RankCrewwisepercentage]");
        ...
        public List<Dashboardchart> DashboardStaffWisePercentage(SearchCriteria search)
        {
            ...
            try
            {
                SqlCommand cmd = sqlHelper.GetStoreProcedureCommand("[dbo].[sp_DashboardSelectedStaffWisePercentage]");
        ...
        public List<Dashboardchart> Dashboard_one_StaffWisePercentage(SearchCriteria search)
        {
            ...
            try
            {
                SqlCommand cmd = sqlHelper.GetStoreProcedureCommand("[dbo].[sp_Dashboardcrewdatewisepercentage]");
                ...
                if (Dr.HasRows)
                {
                    while (Dr.Read())
                    {
                       ...
                       // if (search.StaffID.Equals(obj_Dashboardchart.StaffID))
                       // {
        ...
        public List<Dashboardchart> DashboardOnload_one_StaffWisePercentage(SearchCriteria search)
        {
            ...
            try
            {
                SqlCommand cmd = sqlHelper.GetStoreProcedureCommand("[dbo].[sp_DashboardOnloadCrewDatewisePercentage]");
        ...
        public List<Dashboardchart> Dashboard_all_StaffWisePercentage(SearchCriteria search)
        {
            ...
            try
            {
                //SqlCommand cmd = sqlHelper.GetStoreProcedureCommand("[dbo].[sp_Dashboardallcrewwisepercentage]");
                SqlCommand cmd = sqlHelper.GetStoreProcedureCommand("[dbo].[sp_CabinNew1]");
        ...
        public List<Dashboardchart> DashboardCrewRankWisePercentage(SearchCriteria search)
        {
            ...
            try
            {
                SqlCommand cmd = sqlHelper.GetStoreProcedureCommand("[dbo].[sp_DashboardCrewRankWisePercentage]");
        ...
        public List<Dashboardchart> DashboardSelectedCrewRankWisePercentage(SearchCriteria search)
        {
            ...
            try
            {
                SqlCommand cmd = sqlHelper.GetStoreProcedureCommand("[dbo].[sp_DashboardselectedRankPercentage]");
        ...
        public List<Dashboardchart> DashboardRosterWisePercentage(SearchCriteria search)
        {
            ...
            try
            {
                SqlCommand cmd = sqlHelper.GetStoreProcedureCommand("[dbo].[sp_DashboardRosterWisePercentage]");
        ...
        public List<Dashboardchart> DashboardSelectedRosterWisePercentage(SearchCriteria search)
        {
            ...
            try
            {
                SqlCommand cmd = sqlHelper.GetStoreProcedureCommand("[dbo].[sp_DashboardSelectedRosterWisePercentage]");
        ...
        public List<Dashboardchart> DashboardOnloadWisePercentage(SearchCriteria search)
        {
            ...
            try
            {
                SqlCommand cmd = sqlHelper.GetStoreProcedureCommand("[dbo].[sp_DashboardOnLoadPercentage]");
        ...
        public List<Dashboardchart> DashboardSelectedValueWisePercentage(SearchCriteria search)
        {
            ...
            try
            {
                SqlCommand cmd = sqlHelper.GetStoreProcedureCommand("[dbo].[sp_DashboardSelectedValueWisePercentage]");
        ...
        public List<Dashboardchart> DashboardMonthWisePercentage(SearchCriteria search)
        {
            ...
            try
            {
                SqlCommand cmd = sqlHelper.GetStoreProcedureCommand("[dbo].[sp_DashboardMonthWisePercentage]");
        ...
        public List<Dashboardchart> DashboardSelectedMonthWisePercentage(SearchCriteria search)
        {
            ...
            try
            {
                SqlCommand cmd = sqlHelper.GetStoreProcedureCommand("[dbo].[sp_DashboardSelectedMonthWisePercentage]");
        ...
        public List<CrewRosterReport> Get_Grid_DashboardBaseWiseDataForGrid(SearchCriteria search)
        {
            ...
            try
            {
                SqlCommand cmd = sqlHelper.GetStoreProcedureCommand("[dbo].[sp_DashboardBaseWiseDataForGrid]");
        ...
        public List<CrewRosterReport> Get_Grid_sp_DashboardStaffWiseDataForGrid(SearchCriteria search)
        {
            ...
            try
            {
                SqlCommand cmd = sqlHelper.GetStoreProcedureCommand("[dbo].[sp_DashboardStaffWiseDataForGrid]");
        ...
        public List<CrewRosterReport> Get_Grid_sp_DashboardStaffnDateWiseDataForGrid(SearchCriteria search)
        {
            ...
            System.Diagnostics.Debug.WriteLine("this is Base" + search.Base.Length);
            System.Diagnostics.Debug.WriteLine("this is Base" + search.Base);
            System.Diagnostics.Debug.WriteLine("this is Rank"+ search.CrewRank.Length);
            System.Diagnostics.Debug.WriteLine("this is Rank" + search.CrewRank);

            String sp_var = "newsp";
            if ((search.Base.Length > 3) || (search.CrewRank.Length > 4))
            {
                sp_var = "[dbo].[sp_DashboardStaffnDateWiseDataForGridMultipleBaseAndRank]";
                System.Diagnostics.Debug.WriteLine("sp_var" + sp_var);
            }
            else {

                sp_var = "[dbo].[sp_DashboardStaffnDateWiseDataForGrid]";
                System.Diagnostics.Debug.WriteLine("sp_var" + sp_var);
            }
            try
            {
                SqlCommand cmd = sqlHelper.GetStoreProcedureCommand(sp_var);
        ...
        public List<CrewRosterReport> Get_Grid_sp_DashboardCrewRankWiseDataForGrid(SearchCriteria search)
        {
            ...
            try
            {
                SqlCommand cmd = sqlHelper.GetStoreProcedureCommand("[dbo].[sp_DashboardCrewRankWiseDataForGrid]");
        ...
        public List<CrewRosterReport> Get_Grid_sp_DashboardOnloadWiseDataForGrid(SearchCriteria search)
        {
            ...
            try
            {
                SqlCommand cmd = sqlHelper.GetStoreProcedureCommand("[dbo].[sp_DashboardOnLoadDataForGrid]");
              ...
              // sqlHelper.AddParameter(cmd, "@ReportDropdownValue", SqlDbType.VarChar, 100, ParameterDirection.Input, search.ReportDropdownValue);
                ...
                System.Diagnostics.Debug.WriteLine("this is pankaj DB");
                System.Diagnostics.Debug.WriteLine("Base" + search.Base);
                System.Diagnostics.Debug.WriteLine("crewRank" + search.CrewRank);
                System.Diagnostics.Debug.WriteLine("staffId" + search.StaffID);
                System.Diagnostics.Debug.WriteLine("empname" + search.EmployeeName);
                System.Diagnostics.Debug.WriteLine("selectedChangeType" + search.selectedChangeType);
                System.Diagnostics.Debug.WriteLine("search.FromDate" + search.FromDate);
                System.Diagnostics.Debug.WriteLine("ToDate" + search.ToDate);
